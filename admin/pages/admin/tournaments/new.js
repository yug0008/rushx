    ...
    try {
      ...
      await supabase
        ...
        .insert({
          ...
          message: `Tournament "${formData.title}" has been created successfully.`,
          type: 'success',
          related_tournament_id: data[0].id
        })
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center space-x-4 mb-4 lg:mb-0">
              ...
              <div>
                ...
                <p className="text-cyan-400">Setup a new tournament with all details</p>
              </div>
            </div>
