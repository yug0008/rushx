...
const EditTournamentPage = () => {
  ...
  const { edit: tournamentId } = router.query
    ...
    rules: {
      sections: [
        ...
        },
        {
          ...
          rules: [
            'Default game settings will be used',
            'Custom room settings will be provided before match'
          ]
        }
      ]
    },
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-500/20 border border-red-500/50 text-red-400 rounded-lg hover:bg-red-500/30 transition-colors duration-300 flex items-center space-x-2"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Will be used in URL: /tournaments/{formData.slug}
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('prize_pool.fourthPlace', parseFloat(e.target.value))}
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('prize_pool.fifthPlace', parseFloat(e.target.value))}
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500 transition-colors"
                />
              </div>
